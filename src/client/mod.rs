    ...
    F: Future<Item=Response<Body>, Error=hyper::Error> + Send + 'static
{
        ...
        context: &C) -> Box<dyn Future<Item=I2cBusReadBytesResponse, Error=ApiError> + Send>
    {
        let mut uri = format!(
            ...
            ,bus_id=utf8_percent_encode(&param_bus_id.to_string(), ID_ENCODE_SET)
            ,addr=utf8_percent_encode(&param_addr.to_string(), ID_ENCODE_SET)
            ,num_bytes=utf8_percent_encode(&param_num_bytes.to_string(), ID_ENCODE_SET)
        );
        ...
        context: &C) -> Box<dyn Future<Item=I2cBusReadRegResponse, Error=ApiError> + Send>
    {
        let mut uri = format!(
            ...
            ,bus_id=utf8_percent_encode(&param_bus_id.to_string(), ID_ENCODE_SET)
            ,addr=utf8_percent_encode(&param_addr.to_string(), ID_ENCODE_SET)
            ,reg=utf8_percent_encode(&param_reg.to_string(), ID_ENCODE_SET)
            ,num_bytes=utf8_percent_encode(&param_num_bytes.to_string(), ID_ENCODE_SET)
        );
        ...
        context: &C) -> Box<dyn Future<Item=I2cBusWriteByteResponse, Error=ApiError> + Send>
    {
        let mut uri = format!(
            ...
            ,bus_id=utf8_percent_encode(&param_bus_id.to_string(), ID_ENCODE_SET)
            ,addr=utf8_percent_encode(&param_addr.to_string(), ID_ENCODE_SET)
            ,value=utf8_percent_encode(&param_value.to_string(), ID_ENCODE_SET)
        );
